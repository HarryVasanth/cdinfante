        ...
        <main className="flex-1 space-y-24">
          ...
          <section id="typography" className="scroll-mt-32">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.typography.typefaces')}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10">
                    <p className="text-4xl font-plus-jakarta mb-4 text-brand-navy dark:text-white">Plus Jakarta Sans</p>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Primary Brand Font. Used for headings, body text, and UI elements.</p>
                  </div>
                  <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10">
                    <p className="text-4xl font-sans mb-4 text-brand-navy dark:text-white">Inter</p>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">System fallback font. Clean, modern, and highly legible.</p>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.typography.font_sizes')}</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.label} className="flex items-baseline gap-4 p-4 rounded-xl bg-slate-50 dark:bg-white/5">
                      <span className="w-20 text-xs font-mono text-slate-400">{item.label}</span>
                      <span className="w-16 text-xs text-slate-400">{item.size}</span>
                      <span className={cn(item.label, "text-brand-navy dark:text-white truncate")}>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.typography.font_weights')}</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={item.weight} className="p-4 rounded-xl border border-slate-200 dark:border-white/10 text-center">
                      <p className={cn(item.weight, "text-2xl text-brand-navy dark:text-white mb-1")}>Aa</p>
                      <p className="text-xs font-mono text-slate-400">{item.weight}</p>
          ...
          <section id="theming" className="scroll-mt-32">
            ...
            <div className="space-y-12">
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.theming.colors')}</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ColorSwatch color="#001e40" name="Brand Navy" variable="--color-brand-navy" />
                  <ColorSwatch color="#b6171e" name="Brand Red" variable="--color-brand-red" />
                  <ColorSwatch color="#fdfdfd" name="Light Background" variable="--background" dark={false} />
                  <ColorSwatch color="#020202" name="Dark Background" variable="--background" dark={true} />
                </div>
              </div>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.theming.spinner')}</h3>
                <div className="flex gap-8 items-center p-8 rounded-2xl bg-slate-50 dark:bg-white/5">
                  <Loader2 className="animate-spin text-brand-navy dark:text-white" size={24} />
                  <Loader2 className="animate-spin text-brand-red" size={32} />
                  <Loader2 className="animate-spin text-brand-navy dark:text-white" size={48} />
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="components" className="scroll-mt-32">
            ...
            <div className="space-y-16">
              {/* Flags */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.flags')}</h3>
                <div className="flex gap-4 p-8 rounded-2xl border border-slate-200 dark:border-white/10">
                  <div className="w-12 h-8 bg-brand-navy rounded shadow-sm flex items-center justify-center text-white text-[10px] font-bold">CDI</div>
                  <div className="w-12 h-8 bg-brand-red rounded shadow-sm flex items-center justify-center text-white text-[10px] font-bold">PT</div>
                  <div className="w-12 h-8 bg-slate-200 rounded shadow-sm flex items-center justify-center text-slate-400 text-[10px] font-bold">UK</div>
                </div>
              </div>

              {/* Text Standards */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.text_standards.title')}</h3>
                <div className="space-y-8 p-8 rounded-2xl border border-slate-200 dark:border-white/10">
                  <div>
                    <p className="text-xs text-slate-400 mb-2">{t('docs.components.text_standards.title_item')}</p>
                    <h1 className="text-4xl font-bold text-brand-navy dark:text-white">Main Page Title</h1>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 mb-2">{t('docs.components.text_standards.modal_title')}</p>
                    <h2 className="text-2xl font-semibold text-brand-navy dark:text-white">Modal or Dialog Title</h2>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 mb-2">{t('docs.components.text_standards.section')}</p>
                    <h3 className="text-lg font-semibold uppercase tracking-wider text-brand-red">Section Header</h3>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 mb-2">{t('docs.components.text_standards.text')}</p>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                      Standard body text for paragraphs and long-form content. Ensuring optimal readability with appropriate line-height and color contrast.
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 mb-2">{t('docs.components.text_standards.label')}</p>
                    <span className="text-sm font-medium text-slate-500">Form Input Label</span>
                  </div>
                </div>
              </div>
              ...
              {/* Indicators */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.indicators.title')}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <p className="text-xs text-slate-400">{t('docs.components.indicators.ribbon')}</p>
                  ...
                  <div className="space-y-4">
                    <p className="text-xs text-slate-400">{t('docs.components.indicators.banner')}</p>
                    <div className="bg-brand-navy text-white px-4 py-3 rounded-xl flex items-center gap-3">
                      <Bell size={18} />
                      <span className="text-sm font-medium">Important club update regarding next competition.</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Links */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.links.title')}</h3>
                <div className="flex gap-8 items-center p-8 rounded-2xl bg-slate-50 dark:bg-white/5">
                  <a href="#" className="text-brand-red hover:underline flex items-center gap-1">
                  ...
                  <button className="flex items-center gap-2 text-slate-500 hover:text-brand-navy dark:hover:text-white transition-colors cursor-pointer">
                    <ArrowLeft size={18} /> {t('docs.components.links.back_link')}
                  </button>
                </div>
              </div>
              ...
              {/* Buttons */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.buttons.title')}</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.navbar')} & UI Elements</h3>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white dark:bg-white/5 rounded-xl border border-slate-100 dark:border-white/5 shadow-sm">
                    <div className="flex items-center gap-8">
                      ...
                      <nav className="hidden md:flex gap-4">
                        <span className="text-sm font-medium text-brand-red">Active</span>
              ...
              {/* Form Inputs */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.form_inputs.title')}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 rounded-2xl border border-slate-200 dark:border-white/10">
                  <div className="space-y-4">
                    <label className="text-sm font-medium">{t('docs.components.form_inputs.text_input')}</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-4">
                    <label className="text-sm font-medium">{t('docs.components.form_inputs.text_area')}</label>
                    <textarea
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <label className="text-sm font-medium">{t('docs.components.form_inputs.generate_input')}</label>
              ...
              {/* Form Controls */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.form_controls.title')}</h3>
              ...
              {/* Cards */}
              <div>
                <h3 className="text-xl font-semibold mb-6">{t('docs.components.cards.title')}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-6 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-xl shadow-slate-200/50 dark:shadow-none">
                    ...
                    <h4 className="text-xl font-bold mb-2">{t('docs.components.cards.card')}</h4>
                    <p className="text-slate-500 text-sm mb-4">A standard content card with elevation and rounded corners.</p>
                    <button className="text-brand-red font-semibold text-sm">Read More</button>
                  </div>
                  <div className="flex flex-col gap-4">
                    {[1, 2].map(i => (
                      <div key={i} className="p-4 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-brand-red/10 text-brand-red flex items-center justify-center">
                          <Activity size={20} />
                        </div>
                        <div>
                          <p className="font-bold text-sm">{t('docs.components.cards.list_card')} #{i}</p>
                          <p className="text-xs text-slate-500">Secondary information text</p>
                        </div>
                        <MoreHorizontal className="ml-auto text-slate-300" />
                      </div>
                    ))}
                    <div className="p-4 rounded-2xl bg-brand-navy text-white">
                      <h5 className="text-xs font-bold uppercase tracking-widest mb-3 opacity-60">{t('docs.components.cards.events_panel')}</h5>
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <div className="w-2 h-2 rounded-full bg-brand-red" />
                          <span className="text-sm font-medium">Training Session - 18:00</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-6">{t('docs.components.resizable_container')}</h3>
          ...
          <section id="containers" className="scroll-mt-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-sm font-medium text-slate-400">{t('docs.components.containers.page_container')}</p>
              ...
              <div className="space-y-8">
                <div className="space-y-2">
                  <p className="text-sm font-medium text-slate-400">{t('docs.components.containers.container_shadow')}</p>
                  <div className="w-full h-20 bg-white dark:bg-white/5 rounded-2xl shadow-[0_20px_50px_rgba(0,30,64,0.15)] dark:shadow-none" />
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-slate-400">{t('docs.components.containers.container_inset')}</p>
...
function ColorSwatch({ color, name, variable, dark }: { color: string; name: string; variable: string; dark?: boolean }) {
  return (
    <div className={cn("space-y-3", dark === true ? "hidden dark:block" : dark === false ? "dark:hidden" : "")}>
      <div
        className="w-full h-24 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm"
        style={{ backgroundColor: color }}
      />
      <div>
        <p className="font-bold text-sm text-brand-navy dark:text-white">{name}</p>
